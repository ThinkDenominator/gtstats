...
<div class="gs-strip-item"><p class="gs-strip-label">Report</p><p class="gs-strip-fns">tbl_stats()<br>save_output()</p></div>
</div>
...
and variance checks, Table 1, focused group comparisons, crosstabs,
...
Each object prints as a publication-ready table. `tbl_stats()` is optional: use
it when you want to add a title, customise the appearance, or export a `gt`
table.
