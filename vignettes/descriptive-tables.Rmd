...
categorical variable. Optionally add exact binomial confidence intervals with
`ci = TRUE`.
...
- Categorical variables: chi-squared test when all expected cell counts are at
  least 5; Fisher's exact test otherwise
