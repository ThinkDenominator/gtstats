...
adds a data dictionary, Table 1 presentation controls, an in-session history,
...
It does not change the analysis algorithms or replace a reproducible R script.
...
Bartlett's test is sensitive to non-normality: a p-value neither proves equal
variances nor replaces the prespecified `var_equal` choice.
