...
Save a `gtstats` result, rendered `gt_tbl`, or `ggplot2` plot. The
object determines the export route automatically. The file type is
...
- x:
  ...
  A `gtstats` result, rendered `gt_tbl`, or `ggplot2` plot.
